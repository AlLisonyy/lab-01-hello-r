...
dino_data %>%
  summarize(r = cor(x, y))
```
This nonlinear relationship has indicated a slightly negative correlation between the variables x and y. Having a visualized graph of the correlation helps us better understand the graph in terms of whether it is a curve or linear. 
